...
LABELS = os.path.join(os.path.dirname(
    os.path.abspath(__file__)), "../models/tpucoco/coco_labels.txt")
MODELS = os.path.join(os.path.dirname(
    os.path.abspath(__file__)), "../models/tpucoco/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite")
...
class HumanDetection:
    ...
    def predict(self, img):
        ...
        objs = detect.get_output(self.interpreter, self.confidence, scale, True)
        return objs
